...
<script>
	...
	yOffset = pb.max.y - po.y/2;

	southWest = map.unproject([0, h + yOffset], map.getMaxZoom());
	northEast = map.unproject([w, 0 + yOffset], map.getMaxZoom());
	...
	var m = {
		t: 411,
		l: actualY(map.getMaxZoom(),893 + yOffset),
		b: 1325,
		r: actualY(map.getMaxZoom(),955 + yOffset)
	};
